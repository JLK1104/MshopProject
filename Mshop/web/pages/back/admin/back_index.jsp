...
<link href="/Mshop/CSS/back/font-awesome.min.css" rel="stylesheet"
	type="text/css">
			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="charts.html"> <i
						class="fa fa-fw fa-area-chart"></i> <span class="nav-link-text">图表</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Components"><a
					class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
					href="#collapselist" data-parent="#exampleAccordion"> <i
...
<%-- 				onclick="updateAll(<%=updatelock%>,'all','mid')"></span> --%>
<!-- 		</div> -->
<!-- 	</div> -->
	<!-- /.container-fluid-->
	<!-- /.content-wrapper-->
	<footer class="sticky-footer">
		<div class="container">
			<div class="text-center">
				<small>Copyright © Your Website 2017 / More Templates <a
					href="#" target="_blank" title="JLK">JLK</a> - Collect from <a
					href="#" title="JLK" target="_blank">JLK</a></small>
			</div>
		</div>
	</footer>
